...
void tasksDatabase::connectToDatabase(QString nameDatabase, tcpServer *server)
{
    ...
    connect(server, SIGNAL(commandReady(QString)), this, SLOT(insertDataToTable(QString)));
}
...
void tasksDatabase::insertDataToTable(QString command)
{
    QSqlQuery query;
